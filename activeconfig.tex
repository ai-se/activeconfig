...
\end{tabular}
\caption{\respto{1a}~Spectral Learning using \what{} using a synthetic example of a system with two configurations.}
...
\noindent
This is definitely a good point. Our previous version of the paper did not mention these details in an accessible format. In this version we have added a detailed table mentioning the details about how the data is collected and clearly define how performance is measured~\citeresp{2b}.\\
...
\noindent
Regarding the importance of different configuration, we did not make any assumptions on whether some or all configurations are important. We assumed that all configurations are of equal importance and perform no pre-processing on the data.\\

\noindent
\review{why the huge \# configurations for SQLite vs others - was not clear from the discussion.}\\
In this new draft, we add mention why SQLite has huge number of configuration~\citeresp{2d}.\\
