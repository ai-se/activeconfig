...
\subsection{Results}
Our sampling methods are stochastic in nature and hence we have repeated the experiments 20 times to reported the variance(which represents stability of our results). 
...
attained by using larger data sample. 
...
\bi
    ...
    which mean the technique saves time while preserving accuracy and variability.}
\ei
\begin{figure}[!t]
