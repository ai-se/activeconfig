...
Their first method, called feature-wise ({\em FW}), is their basic method.
...
\begin{compactenum}
\item Find a pair of  configurations $C_1$ and $C_2$, where $C_2$ uses exactly the same features as $C_1$, plus just one  extra feature $f$.
...
just compiles and executes just these smallest $C_1$ and $C_2$ configurations. 
...
\todo[inline]{The below paragraph needs to be moved to the experiments section!}
...
\todo[inline]{Sorry, I dont see a clear distinction.}
