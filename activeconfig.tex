...
To answer this question, 20 times, we ran generated a random set of 100 configurations then based that baseline to three optimizers(GALE and two other optimisers,  described in \textcolor{red}{\ig{opt})}.
