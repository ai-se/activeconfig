...
\bi
    ...
    \item{Research Questions}
        \bi
            \item{Can we achieve a reasonable prediction accuracy based on a small training set which is feasible?}
            \item{Does less data mean more variance ?}
            \item{Can we use fast learner to find the configuration with lowest performance?}
        \ei
\ei
