...
In our work, we use the time saved by the proposed sampling when compared to the baseline method ($2/3$ of configuration space) is presented along with the prediction accuracy (similar to \cite{guo2013variability, siegmund2012predicting, westermann2012automated}). We also use the cost model introduced in \cite{sarkar2015cost}, that takes into account measurement effort along with prediction accuracy. 
    \begin{figure}[!t]
