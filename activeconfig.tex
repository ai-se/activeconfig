...
After collecting the data using one of the sampling policies, we then use the CART regression tree learner \cite{breiman1984} to build a predictor for performance scores. Regression tree learners seek the attribute range split that most increases
...
CART finds the ``best'' split as the one that minimizes $\frac{n_1}{n}\sigma_1 + \frac{n_2}{n}\sigma_2$.
