...
\end{tabular}
\caption{\respto{1a}~Spectral Learning using \what{} using the  example of a system with two configuration options.}
...
\begin{adjustbox}{addcode=
    ...
    {\caption{\respto{2b}~Subject systems used in the experiments.}\label{fig:systems}\end{minipage}},angle=90}
{\footnotesize
% \caption{\respto{2b}~Subject systems used in the experiments.}
\begin{tabular}{p{1.25cm}p{2.5cm}cp{0.35cm}p{6cm}p{1cm}p{3cm}p{1cm}}
\toprule
                     & \textbf{Description}                                                                                                      & \textbf{LOC}     & \textbf{\begin{tabular}[c]{@{}l@{}}Feat\\-ures\end{tabular}} & \textbf{Configurations}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          & \textbf{\begin{tabular}[c]{@{}l@{}}\#Configu\\-rations\end{tabular}}& \textbf{\begin{tabular}[c]{@{}l@{}}Benchmark Used\end{tabular}}                                                                                                   & \textbf{\begin{tabular}[c]{@{}l@{}}Performance\\Metric\end{tabular}} \\ \cmidrule{1-8}
\textbf{Apache}                                                                    & Apache is a prominent open-source Web server that comes with various configuration options.                      & 230,277 & 9        & Base, HostnameLookups, KeepAlive, EnableSendfile, FollowSymLinks, AccessLog, ExtendedStatus, InMemory, Handle                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           & 192               & We used the tools autobench and httperf to generate load on the Web server. We increased the load until the server could not, handle any, further requests & Maximum load~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~                                                 \\ 
\\ \textbf{\begin{tabular}[t]{@{}l@{}}Berkeley DB\\C Edition\\ (BDBC)\end{tabular}}    & BDBC is an embedded database system written in C.                                                                & 219,811 & 18       & HAVE\_CRYPTO, HAVE\_HASH, HAVE\_REPLICATION, HAVE\_VERIFY, HAVE\_SEQUENCE, HAVE\_STATISTICS, DIAGNOSTIC, PAGESIZE, PS1K, PS4K, PS8K, PS16K, PS32K, CACHESIZE, CS32MB, CS16MB, CS64MB, CS512MB                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           & 2,560             & Benchmark provided by the vendor                                                                                                                           & Response time                                                \\ 
\\ \textbf{\begin{tabular}[t]{@{}l@{}}Berkeley DB\\Java Edition\\ (BDBJ)\end{tabular}} &BDBJ is a complete re-development of BDBC in Java with full SQL support.                                         & 42,596  & 32       &Base, Persistence, IO, OldIO, NewIO, NIOBase, NIOType, ChunkedNIO, SingleWriteNIO, DirectNIO, LogSize, S100MiB, S1MiB, Checksum, BTreeFeatures, INCompressor, IEvictor, Evictor, Critical\_Eviction, Verifier, ITracing, Tracing, TracingLevel, Severe, Finest, Statistics                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              & 400               & Benchmark provided by the vendor                                                                                                                           & Response time                                                \\ 
\\ \textbf{LLVM}                                                                      & LLVM is a compiler infrastructure written in C++.                                                                 & 47,549  & 11       & time\_passes, gvn, instcombine, inline, jump\_threading, simplifycfg, sccp, print\_used\_types, ipsccp, iv\_users, licm                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 & 1,024             & As benchmark, we measured the time to compile LLVM’s test suite                                                                                            & Time to compile LLVM’s test suite                            \\ 
...
\\ \textbf{x264}                                                                      & x264is a video encoder in C that provides configuration options to adjust output quality of encoded video files. & 45,743  & 16       & no\_asm, no\_8x8dct, no\_cabac, no\_deblock, no\_fast\_pskip, no\_mbtree, no\_mixed\_refs, no\_weightb, rc\_lookahead, rc\_lookahead\_20, rc\_lookahead\_40, rc\_lookahead\_60, ref, ref\_1, ref\_5, ref\_9                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             & 1,152             & As benchmark, we encoded the Sintel trailer (735 MB) from AVI to the xH.264 codec                                                                          & Encoding time                                                \\ 
\end{tabular}
...
\noindent
We agree with your observation that it is less important to claim about the efficiency of the spectral method since, major cost lies in acquiring the performance score of the configuration for the current systems under study. However, there exist some systems such as SaC~\cite{temple2017learning} which have 65,425 possible configurations, where actual computation of principal component might take significantly longer time. 


\subsection*{\textbf{Response to Reviewer \#2}}
\noindent
\review{The motivation could be strengthened - ideally using a concrete example e.g. one of the benchmark applications.}\\

\noindent
We agree with you and hence we add a new section~\citeresp{2e}.\\

\noindent
\review{Now - how restrictive is this? I would like this discussed both in the introduction/ motivation but
especially in the threats/validity and perhaps discussion/future work.}\\
\noindent
...
\noindent
\textcolor{red}{We mention this in section 5.3.}
