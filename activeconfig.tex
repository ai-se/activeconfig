...
\begin{figure}[th]
\centering
\includegraphics[width=0.5\columnwidth]{Figures/SamplingAccuracy}
...
\begin{figure}[th]
\includegraphics[width=0.5\columnwidth]{Figures/Variance}
...
\begin{figure}[ht]
\includegraphics[width=\columnwidth]{Figures/underlying_dimension}
\caption{Errors of the predictions made by \what with four different
sampling policies. Note that, on the y-axis,  {\em lower} errors are {\em better}.
}
