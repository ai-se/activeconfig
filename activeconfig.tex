...
our measurements. Its error results are within 1\,\% of \what;
 ...
 estimate is   larger than \what  (see the \framebox{\colorbox{whatcolor}{\textcolor{whatcolor}{\bf red}}} bars in the left and middle plots   of Figure~\ref{fig:Comparison}). Furthermore, in the case of BDBC, the error values
